          ...
          <div class="card-body">
            ...
            <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
              ...
              <ul class="nav nav-pills" [ngbScrollSpyMenu]="s">
                <li class="nav-item">
                  <a class="nav-link" ngbScrollSpyItem="fat">&#64;fat</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" ngbScrollSpyItem="mdo">&#64;mdo</a>
                </li>
            ...
            <div class="row">
              <div class="col-2">
                ...
                >
                  <nav class="nav nav-pills flex-column">
                    <a class="nav-link" ngbScrollSpyItem="item-1">Item 1</a>
                    <nav class="nav nav-pills flex-column">
                      <a
                        class="nav-link ms-3 my-1"
                        ngbScrollSpyItem="item-1-1"
                        parent="item-1"
                        >Item 1-1</a
                      >
                      <a
                        class="nav-link ms-3 my-1"
                        ngbScrollSpyItem="item-1-2"
                        parent="item-1"
                        >Item 1-2</a
                      >
                    </nav>
                    <a class="nav-link" ngbScrollSpyItem="item-2">Item 2</a>
                    <a class="nav-link" ngbScrollSpyItem="item-3">Item 3</a>
                    <nav class="nav nav-pills flex-column">
                      <a
                        class="nav-link ms-3 my-1"
                        ngbScrollSpyItem="item-3-1"
                        parent="item-3"
                        >Item 3-1</a
                      >
                      <a
                        class="nav-link ms-3 my-1"
                        ngbScrollSpyItem="item-3-2"
                        parent="item-3"
                        >Item 3-2</a
                      >
                    </nav>
              ...
              <div class="col-10">
                <div
                  ...
                  style="height: 350px"
                >
                  <h4 ngbScrollSpyFragment="item-1">Item 1</h4>
                  <p>
                  ...
                  <h5 ngbScrollSpyFragment="item-1-1">Item 1-1</h5>
                  <p>
                  ...
                  <h5 ngbScrollSpyFragment="item-1-2">Item 1-2</h5>
                  <p>
                  ...
                  <h4 ngbScrollSpyFragment="item-2">Item 2</h4>
                  <p>
                  ...
                  <h4 ngbScrollSpyFragment="item-3">Item 3</h4>
                  <p>
                  ...
                  <h5 ngbScrollSpyFragment="item-3-1">Item 3-1</h5>
                  <p>
                  ...
                  <h5 ngbScrollSpyFragment="item-3-2">Item 3-2</h5>
                  <p>
                ...
                <div class="col-2">
                  <div id="list-example" class="list-group">
                    <a
                      ...
                      [ngbScrollSpyItem]="[listspy, 'items-1']"
                      >Item 1</a
                    >
                    <a
                      class="list-group-item list-group-item-action"
                      [ngbScrollSpyItem]="listspy"
                      fragment="items-2"
                      >Item 2</a
                    >
                    <a
                    ...
                    <a
                      class="list-group-item list-group-item-action"
                      [class.active]="listspy.active === 'items-4'"
                      (click)="
                        listspy.scrollTo('items-4'); $event.preventDefault()
                      "
                      >Item 4</a
                    >
                  </div>
